...
public class EntryClass {
	...
	public static void main(String[] args) {
		...
		StudentDTO studentDTO = new StudentDTO("Test College of Technology", 12, "Test Student", 89.7, Boolean.TRUE, addressDTO);
		DocumentRequestDTO documentRequestDTO = new DocumentRequestDTO("StudentReport.pdf", DocumentType.PDF,
				"studentReport.ftl", "TEST COLLEGE", studentDTO);
